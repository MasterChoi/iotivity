...
public:
    ...
    LightResource(std::string nm_name, bool nm_state, int nm_power, std::string nm_lightUri, OCResourceHandle nm_resourceHandle) {	
		m_name = nm_name;
		m_state = nm_state;
		m_power = nm_power;
		m_lightUri = nm_lightUri;
		m_resourceHandle = nm_resourceHandle;
...
int main(int argc, char* argv[])
{
    ...
    try
    {
        ...
        LightResource myLight_1("light_1",false,0,"/a/light_1",nullptr);
		LightResource myLight_2("light_2",false,0,"/a/light_2",nullptr);
        // Invoke createResource function of class light.
        myLight_1.createResource();
		myLight_2.createResource();

        std::cout << "Created resource." << std::endl;

        myLight_1.addType(std::string("core.brightlight"));
        myLight_1.addInterface(std::string(LINK_INTERFACE));
		myLight_2.addType(std::string("core.brightlight"));
		myLight_2.addInterface(std::string(LINK_INTERFACE));
